...
val oreBlockCoal = [
        ...
        <pyrotech:dense_nether_coal_ore> //coal
...
val oreBlockMagnetite = [
        <primal:ore_magnetite>, //magnetite
        <primal:ore_magnetite:1>, //magnetite
        <primal:ore_magnetite:2> //magnetite

    ];
        for block in oreBlockMagnetite {
            //oreDictMagnetite.removeItems(block);
            oreDictMagnetite.addItems(block);
        }
