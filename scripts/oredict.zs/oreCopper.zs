...
print("Init: 'oreCoppper.zs'");

//Iron
    //Ore
        var MainOre = <immersiveengineering:ore>;

    //Cluster
        var Cluster = <geolosys:cluster:2>;

    //RockyChunks
        var ChunkRocky = <magneticraft:rocky_chunks:2>;

    //CleanChunks
        var ChunkClean = <magneticraft:chunks:2>;

    //Dust
        var Dust = <immersiveengineering:metal:9>;

    //Ingot
        var Ingot = <geolosys:ingot>;

    //Nugget
        var Nugget = <immersiveengineering:metal:20>;

    //Block
        var Block = <immersiveengineering:storage>;

    //Plate
        var Plate = <immersiveengineering:metal:30>;
    ...
    //Rod
        var Rod = <immersiveposts:metal_rods:1>;
