...
print("Init: 'oreSilver.zs'");

//Iron
    //Ore
        var MainOre = <immersiveengineering:ore:3>;

    //Cluster
        var Cluster = <geolosys:cluster:4>;

    //RockyChunks
        var ChunkRocky = <magneticraft:rocky_chunks:12>;

    //CleanChunks
        var ChunkClean = <magneticraft:chunks:12>;

    //Dust
        var Dust = <immersiveengineering:metal:12>;

    //Ingot
        var Ingot = <geolosys:ingot:2>;

    //Nugget
        var Nugget = <immersiveengineering:metal:23>;

    //Block
        var Block = <immersiveengineering:storage:3>;

    //Plate
        var Plate = <immersiveengineering:metal:33>;
    ...
    //Rod
        var Rod = <immersiveposts:metal_rods:3>;

    //Extra
        var Extra = <immersiveengineering:metal:11>; //LeadGrit
//____
